...
public class TinNewsCard {
    ...
    private final OnSwipeListner onSwipeListner;

    public TinNewsCard(Article news, OnSwipeListner onSwipeListner) {
        this.article = news;
        this.onSwipeListner = onSwipeListner;
    }
    ...
    private void onSwipedOut() {
        ...
        onSwipeListner.onDisLike(article);
    }
    ...
    private void onSwipeIn() {
        ...
        onSwipeListner.onLike(article);
    }

    interface OnSwipeListner {
