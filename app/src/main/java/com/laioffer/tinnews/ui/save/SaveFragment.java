...
import com.laioffer.tinnews.ui.detail.SavedNewsDetailFragment;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        savedNewsAdapter.setOnClickListener(new SavedNewsAdapter.OnClickListener() {
            ...
            public void onClick(Article article) {
                SaveFragmentDirections.ActionTitleSaveToDetail
                        actionTitleSaveToDetail =
                        SaveFragmentDirections.actionTitleSaveToDetail();
                actionTitleSaveToDetail.setArticle(article);
                NavHostFragment.findNavController(SaveFragment.this)
                        .navigate(actionTitleSaveToDetail);
            }
